...
class GuestPageController extends Controller
{
    ...
    {
        // method dipanggil saat mengakses url /user (GET|HEAD)
    ...
    {
        // method dipanggil saat mengakses url /user/create (GET|HEAD)
    ...
    {
        //  method dipanggil saat mengakses url /user (POST)
    ...
    {
        //  method dipanggil saat mengakses url /user/{user} (GET|HEAD)
    ...
    {
        //  method dipanggil saat mengakses url /user/{user}/edit (GET|HEAD)
    ...
    {
        //  method dipanggil saat mengakses url /user/{user}/edit (PUT|PATCH)
    ...
    {
        //  method dipanggil saat mengakses url /user/{user} (DELETE)
